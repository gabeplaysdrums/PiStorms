...
class mindsensorsUI():
    ...
    def drawArrows(self,display = True):
        ...
        self.drawButton(self.screenWidth()-50,0,50,40, ">",display = display)
    ...
    #  @endcode    
    def fillBmp(self, x, y, width, height, path = "/usr/local/lib/python2.7/dist-packages/mindsensors_images/Pane1.png",display = True):
